...
public class DataSourceSelectionScene extends Scene {
    ...
    private static final int DB_PARAMS = 12;
    ...
    private static final String[] DB_PARAM_NAMES = {"Host", "Port", "Database", "User", "Password", "Table", "Minimum Packet Size", "Host Selection", "Host 2 Selection", "Port", "Start Time", "End Time"};
